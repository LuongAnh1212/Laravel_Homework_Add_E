...
<body class="g-sidenav-show  bg-gray-200">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Posts
                                Management</a></li>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ asset('backend/assets/Admin') }}"
                                                ...
                                                <div class="my-form-control">
                                                    ...
                                                    <div>
                                                        <img style="width: 200px; height:auto;"
                                                            src="{{ asset($post->image) }}" alt="Post Image" class="box_image_post" id="box_image_post"/>
                                                        <input class="input_fullName" type="file" id="image_post"
                                                            name="image" accept="image/png, image/jpeg"
                                                            value="{{ asset($post->image) }}" onchange="loadFile(event)"/>
                                                        <div>
                                                            <small class="small">
                                                                @error('image')
                                                                    <div class="error">{{ $message }}</div>
    ...
    <script>
        const list = document.querySelectorAll('.nav-item-link')[2].classList;
        list.add("active");
