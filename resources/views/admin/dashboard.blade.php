...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="../backend/assets/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Dashboard Bog Page</a></li>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="../backend/Admin" class="nav-link text-body font-weight-bold px-0">
    ...
    <script>
        const matches = document.querySelectorAll("a.nav-item-link");
        const list = matches[0].classList;
        list.add("active");
    ...
    <script src="../backend/assets/js/material-dashboard.min.js?v=3.1.0"></script>
</body>
